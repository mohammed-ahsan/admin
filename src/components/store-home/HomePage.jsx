  ...
  return (
    <>
      <div className="grid grid-cols-12 font-sans pr-4">
              ...
              <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3 relative">
                ...
                <div className="sm:col-span-4">
                  <InputAreaTwo
                    ...
                    type="text"
                    placeholder="https://Gigapixel-store.vercel.app/search?category=fruits-vegetable&_id=632aca2b4d87ff2494210be8"
                  />
        ...
        <div
          className={`col-span-12 md:col-span-12 lg:col-span-12 ${window.innerWidth < 400 ? "md:my-0 my-24" : "md:my-0 my-24"
            }`}
        >
          <div className="inline-flex md:text-lg text-base text-gray-800 font-semibold dark:text-gray-400 mb-3">
        ...
        <div
          className={`col-span-12 md:col-span-12 lg:col-span-12 ${window.innerWidth < 400 ? "md:mt-0 mt-40" : "md:mt-0 mt-10"
            }`}
        >
          <div className="inline-flex md:text-lg text-base text-gray-800 font-semibold dark:text-gray-400 mb-3">
