...
const SubCategory = () => {
  ...
  const [dreawertoogle, setdreawertoogle] = useState(false)
  ...
  return (
    <>
      <PageTitle>{t("Nasted - Category")}</PageTitle>
      ...
      <div className={`w-full h-screen absolute justify-center items-center top-0 left-0 bg-low-dark ${dreawertoogle === true ? "flex" : "hidden"}`}>
        <div className="w-full h-full absolute top-0 left-0" onClick={() => { setdreawertoogle(false) }}>

        </div>
        <Card className="w-[50%] mx-auto h-[500px] shadow-xs overflow-hidden bg-dark-800 dark:bg-gray-100 rounded-t-lg rounded-0 mb-4 relative">
          <div className="w-7 h-7 bg-rose-300 rounded-full absolute right-0 top-0 text-white text-xl flex justify-center items-center cursor-pointer" onClick={() => { setdreawertoogle(false) }}>
            <RxCross2 />
          </div>
          <div className="w-full h-full p-10">
            ...
            <input type="text" className="w-full h-12 bg-slate-400 rounded-lg mb-5" placeholder="Name Nasted Catagory" />
            <label htmlFor="" className="text-white mb-5">
              Description :
            </label>
            <input type="text" className="w-full h-12 bg-slate-400 rounded-lg mb-5" placeholder="Name Nasted Catagory" />
            ...
            <input type="text" className="w-full h-12 bg-slate-400 rounded-lg mb-5" placeholder="Name Nasted Catagory" />
            <input type="text" className="w-full h-12 bg-slate-400 rounded-lg" />
          </div>
        </Card>
      </div>
    </>
